...
public class CrazyShadowAttr {
    ...
    /**
     * 以何种方式添加阴影:<br/>
     * {@link com.ldfeng.shadow.CrazyShadow#IMPL_DRAW} <br/>
     * {@link com.ldfeng.shadow.CrazyShadow#IMPL_WRAP} <br/>
     * {@link com.ldfeng.shadow.CrazyShadow#IMPL_FLOAT} <br/>
     */
    private String impl;
    ...
    /**
     * 仅仅对 {@link com.ldfeng.shadow.CrazyShadow#IMPL_DRAW} 形式的方设置阴影时需要的属性
     */
    ...
    /**
     * 对 {@link com.ldfeng.shadow.CrazyShadow#IMPL_DRAW} 形式表示为背景的圆角角度.<br/>
     * 对 {@link com.ldfeng.shadow.CrazyShadow#IMPL_WRAP} 与
     * {@link com.ldfeng.shadow.CrazyShadow#IMPL_FLOAT}
